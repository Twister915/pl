...
final class BukkitAsyncWorker extends BukkitWorker {
    private final Plugin plugin;

    @Inject BukkitAsyncWorker(Plugin plugin) {
        this.plugin = plugin;
    }

    @Override
    BukkitTask later(Runnable r, long tickDelay) {
        return Bukkit.getScheduler().runTaskLaterAsynchronously(plugin, r, tickDelay);
    }
